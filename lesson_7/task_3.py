...
# и тернарный оператор при необходимости). В результате работы функции исходный список не
# должен измениться.
# Например:
# old_list = [1, -3, 4]
# result = [1, -3, 2]
...
def sqrt_numbers(sqrt_numbers):
    result_list = [math.sqrt(el) if el > 0 else el for el in sqrt_numbers]
    return result_list


result = sqrt_numbers(numbers.copy())
print(result)
print(numbers)
